...
export const create_post = async (new_post) => {
    try {
        ...
        await pool.query(`INSERT INTO posts (user_id, upvotes, yt_url, primary_artist, contest_week, is_winner)
        VALUES('${new_post.user_id}', ${new_post.upvotes}, '${new_post.yt_url}', '${new_post.primary_artist}', ${new_post.contest_week}, ${is_winner});`);
